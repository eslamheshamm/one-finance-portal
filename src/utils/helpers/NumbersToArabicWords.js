		...
		var t = (function () {
			...
			return (
				(e.prototype.overrideConfig = function (e) {
					delete e.tensPrefix,
						e.delimiter && (e.delimiter = e.delimiter.replace(" ", "")),
						e.numberSectionsDelimiter &&
							(e.numberSectionsDelimiter = e.numberSectionsDelimiter.replace(
								" ",
								""
							)),
						...
						t >= 3 && t <= 10
							? (i = n +=
									this.arabicWordConfig.numbers[
										"3e".concat(3 * r, "-1e").concat(3 * r + 1)
									])
							: t >= 11 &&
							  (i = n +=
									this.arabicWordConfig.numbers["1e".concat(3 * r + 1, "+")]);
					}
					return i;
				}),
				...
				(e.prototype.getWordForHundreds = function (e) {
					...
					return (
						1 == r
							...
							: r >= 3 &&
							  r <= 9 &&
							  (t = this.getWordFromThreeHundredToNineHundred(e)),
						t
					);
				}),
				(e.prototype.getWordFromThreeHundredToNineHundred = function (e) {
					return (
		...
		var n = (function () {
			...
			return (
				...
				(e.prototype.process = function (e) {
					...
					return i.join(" ".concat(this.config.getAll().delimiter, " "));
				}),
