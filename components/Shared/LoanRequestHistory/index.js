...
export const LoanRequestHistoryTimeLine = ({ timeline = [] }) => {
	return (
												...
												<div className=" flex flex-col ">
													<div className="flex items-center gap-4">
														<h2 className="font-bold ">
															{card.statusName === "PreApproved" &&
																"مقبول مبدائياً"}
															{card.statusName === "Approved" && "مقبول"}
															{card.statusName === "Pending" &&
																"تعديل البيانات"}
															{card.statusName === "RequestForEdit" &&
																"تعديل المستندات"}
															{card.statusName === "Rejected" && "مرفوض"}
															{card.statusName === "Updated" && "تم التحديث"}

															{card.statusName === "Completed" &&
																"مكتمل الملفات"}
														</h2>
