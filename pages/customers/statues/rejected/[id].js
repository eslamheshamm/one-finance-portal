...
const RejectedCustomer = () => {
	...
	return (
		<DashboardLayout>
			...
			{customerInfo && (
				<section className="w-11/12 mx-auto p-8  shadow-md rounded-2xl bg-white">
					<div className="flex items-center justify-start p-12 pb-0 bg-[#FF4D4D]  rounded-[36px] mb-10">
						<Image
							src="/customer/rejected.png"
							alt="Almasria Logo"
							width={164}
							height={228}
						/>
						<div className="mr-4">
							<h2 className="text-7xl mb-3">للأسف</h2>
							<p className="text-4xl text-white">العميل مرفوض</p>
						</div>
					</div>
					{/* info */}

					{customerInfo && (
						<div className={"py-8   border-gray-100 rounded-3xl"}>
							<div>
								<div className="flex flex-col items-start ">
									<div className="flex items-center mb-3">
										...
										<div className="flex flex-col">
											...
											<p className=""> {customerInfo.customer.idno}</p>
										</div>
									</div>
								</div>
							</div>
					...
					<div className=" flex justify-end">
						...
						>
							<span className="group-hover:text-primary">الرجوع</span>
						</button>
					</div>
				</section>
			)}
